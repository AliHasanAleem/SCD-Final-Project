...
SVC_NAME="actions.runner.AliHasanAleem-SCD-Final-Project.Ali-Mac-Book-Pro"
SVC_NAME=${SVC_NAME// /_}
SVC_DESCRIPTION="GitHub Actions Runner (AliHasanAleem-SCD-Final-Project.Ali-Mac-Book-Pro)"
